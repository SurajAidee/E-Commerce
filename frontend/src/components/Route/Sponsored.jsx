  ...
  return (
    ...
    >
      <div className="flex justify-between w-full">
        ...
        <div className="flex items-start">
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/e/ea/LG_logo_%282014%2C_3D%29.svg"
            style={{ width: "150px", objectFit: "contain" }}
            alt=""
          />
        </div>
        {/* <div className="flex items-start">
          <img
            src="https://www.vectorlogo.zone/util/preview?image=/logos/apple/apple-ar21.svg"
            style={{ width: "150px", objectFit: "contain" }}
            alt=""
          />
        </div> */}
